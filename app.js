...
function fun1(){
   ...
   document.getElementById("litrolav").value = ((document.getElementById("preciolav").value)*(1.6666666667)).toFixed(0); 
    ...
    document.getElementById("amigo").value = "LAVANDINA $"+ precio +" son "+ litros;
...
function fun12(){
   ...
   document.getElementById("preciolav1").value = ((document.getElementById("litrolav1").value)*(0.6)).toFixed(0); 
    ...
    document.getElementById("litrolav1").value = disabled="off";
...
function fun2(){
   ...
   document.getElementById("litrodet").value = ((document.getElementById("preciodet").value)*(1.25)).toFixed(1); 
...
function fun21(){
   ...
   document.getElementById("preciodet1").value = ((document.getElementById("litrodet").value)*(0.8)).toFixed(0); 
...
function fun3(){
   ...
   document.getElementById("litrodes").value = ((document.getElementById("preciodes").value)*(1.6666666667)).toFixed(0); 
    ...
    document.getElementById("amigo").value = "desodorante $"+ precio +" son "+ litros;
    document.getElementById("mensaje1").value = precio+" "+litros;
}
function des500(){
...
function fun31(){
 ...
 //  document.getElementById("preciode1").value = ((document.getElementById("litrodes1").value)*(0.6)).toFixed(0); 
document.getElementById("preciodes1").value = ((document.getElementById("litrodes1").value)*(0.6)).toFixed(0); 
    ...
    document.getElementById("amigo").value = "desodorante "+ litros +"ml son $"+ litros;
    document.getElementById("mensaje1").value = precio+" "+litros;
}
function des500ml(){
...
function fun4(){
   ...
   document.getElementById("litrojab").value = ((document.getElementById("preciojab").value)*(1.25)).toFixed(1); 
    ...
    document.getElementById("amigo").value = "jabon ropa $"+ precio +" son "+ litros;
    document.getElementById("mensaje1").value = precio+" "+litros;
}
function jab500(){
...
function fun41(){
   ...
   document.getElementById("preciojab1").value = ((document.getElementById("litrojab").value)*(0.8)).toFixed(0); 
...
function fun6(){
   ...
   document.getElementById("litrodese").value = ((document.getElementById("preciodese").value)*(1.25)).toFixed(1); 
